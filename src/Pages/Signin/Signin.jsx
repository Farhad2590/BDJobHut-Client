    ...
    <div className="flex items-center justify-center min-h-screen bg-[#289278]">
      <div className="relative w-full max-w-3xl bg-white  shadow-lg perspective-1500 flex">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-2 p-8 space-y-4 w-[50%]">
          ...
          <h1 className="text-3xl text-center font-bold text-[#289278]">Sign In</h1>
          ...
          <div className="text-right">
            <a href="#" className="text-sm text-[#289278] hover:underline">Forgot password?</a>
          </div>
          ...
          <p className="text-center text-sm">Dont have an account? <Link to="/signup" htmlFor="flip" className="text-[#289278] cursor-pointer hover:underline">Sign up now</Link></p>
        </form>
